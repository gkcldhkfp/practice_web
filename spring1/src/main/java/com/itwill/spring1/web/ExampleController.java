...
// (1) servlet-contetx.xml 파일에서는 <context:component-scan .../> 설정
...
public class ExampleController {
    ...
    public void controllerExample() {
    	...
    	// 컨트롤러 메서드가 리턴값이 없는(void로 선언된) 경우,
    	// 요청 주소가 뷰의 이름이 됨.
    }
    ...
    public String redirect() {
    	...
    	// 리다이렉트 방식의 페이지 이동 - 요청 주소가 리다이렉트 되는 주소로 바뀜!
    }
    ...
    public UserDto rest2() {
    	...
    	return UserDto.builder().username("홍길동").age(99).build();
    	//-> REST 컨트롤러가 리턴한 자바 객체를 jackson-databind 라이브러리에
