...
<body>
    <header>
        <h1>Home</h1>
        <h2>${now}</h2>
       <!-- <img alt="bookWall" src="/spring1/images/image.jpg" /> -->
       <!-- <img alt="bookWall" src="./images/image.jpg" />  -->
       <c:url var="image" value="/images/image.jpg" />
       <img alt="omg" src="${image}">
       <!-- img src="http://localhost:8080/spring1/images/image.jpg" / --> 
    </header>
