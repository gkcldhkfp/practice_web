...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getAllComments(){
        ...
        .then((response) => {
            ...
            makeCommentElemnets(response.data);
        })
        .catch((error) => {
            console.log(error) 
        });
    ...
    // 댓글 목록(댓글 객체들의 배열)을 아규먼트로 전달 받아서 HTML을 작성.
    function makeCommentElemnets(data) {
        // 댓글 목록 HTML이 삽입될 div
        ...
        // TODO: 모든 수정 버튼들을 찾아서 클릭 이벤트를 설정.
