...
public enum UserDao {
	 ...
	 * @return 데이터베이스의 users 테이블에서 userid 와 password가 일치하는 레코드가 있으면 null이 아닌 User 타입
	...
	private static final String SQL_SELECT_BY_USER_ID = "select * from users where userid = ?";
	...
	public User selectByUserId(String userid) {
		...
		try {
			conn = ds.getConnection();
			stmt = conn.prepareStatement(SQL_SELECT_BY_USER_ID);
