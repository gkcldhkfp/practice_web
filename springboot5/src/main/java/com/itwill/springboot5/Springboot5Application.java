 ...
 * (1) 메인 클래프(Springboot5Application)에서 @EnableJpaAudithing 에너테이션을 설정.
 * (2) 날짜/시간(LocalDate/LocalDateTime) 필드를 갖는 엔터티(BaseTimeEntity)에서
 * @EntityListeners(AudithingEntityListener.class) 에너테이션을 설정.
 * (3) 날짜/시간 필드(createdTime, modifiedTime)에 @CreatedDate @LastModifiedDate 에너테이션 설정.
 */

@EnableJpaAuditing // JPA Auditing 기능 활성화.
//-> AudithingEntityListener를 사용할 수 있게 설정.
